const CountryPage = {
    ...
    AddEventHandlers: function () {
        $(".modal-footer").on("click", "button[data-role='save']", CountryPage.Helpers.Save);
        $("table" + CountryPage.Variables.TableName).on("click", "button[data-role='delete']", CountryPage.Helpers.Delete);
