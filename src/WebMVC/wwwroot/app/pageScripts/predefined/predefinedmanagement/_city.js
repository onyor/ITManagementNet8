var CityPage = {
    ...
    AddEventHandlers: function () {
        $(".modal-footer").off().on("click", "button[data-role='save']", CityPage.Helpers.Save);
        $("table" + CityPage.Variables.TableName).off().on("click", "button[data-role='delete']", CityPage.Helpers.Delete);
    ...
    Helpers: {
        ...
        Save:  function () {
            iTech.Generated.Save(CityPage.Variables.FormName, CityPage.Variables.SaveMethod);
        },
        Delete:  function () {
            const id = $(this).data("id");
