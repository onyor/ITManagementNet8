    ...
    var i, o = (i = function(t, e) {
        ...
        l = function() {
            ...
            return t.prototype.getElPos = function() {
                ...
                if (this.items.length > 0) this.items.forEach((function (s) {
                    ...
                    }).html(s.value + " - " + o ).attr("id", s.value).data("item", s), r && l.addClass("disabled"), e.push(l)
        ...
        a = function() {
            ...
            return t.prototype.manageInlineDataAttributes = function() {
                ...
                var s = $("<input>");
                s.attr("type", "search"), s.attr("name", this._$el.attr("name") + "_text"), s.attr("id", this._$el.attr("id")), s.attr("disabled", this._$el.attr("disabled")), s.attr("placeholder", this._$el.attr("placeholder")), s.attr("autocomplete", "off"), s.addClass(this._$el.attr("class")), s.attr("fields", this._$el.attr("fields")), s.attr("parent", this._$el.attr("parent")), s.attr("source", this._$el.attr("source")), this._defaultText && s.val(this._defaultText);
                ...
                this._$el.on("keydown", (function(e) {
                    ...
                    !t._dd.isMouseOver && t._dd.isDdMouseOver && t._dd.isShown() ? (setTimeout((function() {
                        t._$el.focus()
                    })), t._$el.focus()) : t._dd.isMouseOver || (t._isSelectElement ? t._dd.isItemFocused ? t._dd.selectFocusItem() : null !== t._selectedItem && "" !== t._$el.val() ? t._$el.trigger("autocomplete.select", t._selectedItem) : "" !== t._$el.val() && null !== t._defaultValue ? (t._$el.val(t._defaultText), t._selectHiddenField.val(t._defaultValue), t._selectedItem = null, t._$el.trigger("autocomplete.select", t._selectedItem)) : ("") : t._$el.trigger("autocomplete.freevalue", t._$el.val()), t._dd.hide())
                ...
                if (null != t) {
                    ...
                    console.log("E=> ", e);
                    console.log("ATTR", this._$el.eq(0).data("fields"));

                    $.each(this._$el.eq(0).data("fields"), (k, v) => {
                        this._selectHiddenField[0].setAttribute(v, e[v]);
                    });

                    "string" == typeof e && (e = {
                        text: e
                    }), this._$el.val(e.value), this._isSelectElement && this._selectHiddenField.val(e.value)
